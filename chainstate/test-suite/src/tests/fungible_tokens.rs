...
fn token_transfer_test(#[case] seed: Seed) {
    utils::concurrency::model(move || {
        ...
        assert_eq!(block.transactions()[0].outputs()[0].value(), &output_value);
        let issuance_outpoint_id: OutPointSourceId = block.get_id().into();
...
fn transfer_split_and_combine_tokens(#[case] seed: Seed) {
    utils::concurrency::model(move || {
        ...
        let block = tf.block(*block_index.block_id());
        let issuance_outpoint_id = block.get_id().into();
        let token_id = token_id(&block.transactions()[0]).unwrap();
        ...
        let split_block = tf
            ...
            .build();
        let split_outpoint_id: OutPointSourceId = split_block.get_id().into();
...
fn burn_tokens(#[case] seed: Seed) {
    utils::concurrency::model(move || {
        ...
        let block_index = tf
            ...
            .unwrap();
        let block = tf.block(*block_index.block_id());
        let first_burn_outpoint_id: OutPointSourceId = block.get_id().into();
        ...
        let block_index = tf
            ...
            .unwrap();
        let block = tf.block(*block_index.block_id());
        let second_burn_outpoint_id: OutPointSourceId = block.get_id().into();
        ...
        let block_index = tf
            ...
            .unwrap();
        let block = tf.block(*block_index.block_id());
        let _: OutPointSourceId = block.get_id().into();
...
fn reorg_and_try_to_double_spend_tokens(#[case] seed: Seed) {
    ...
    utils::concurrency::model(move || {
        ...
        let issuance_outpoint_id: OutPointSourceId = issuance_block.get_id().into();
        ...
        let b1_outpoint_id: OutPointSourceId = block_b1.get_id().into();
        ...
        let c1_outpoint_id: OutPointSourceId = block_c1.get_id().into();
        // Let's add D1
        let block_index = tf
            .make_block_builder()
            .add_transaction(
        ...
        let _: OutPointSourceId = block_d1.get_id().into();
        ...
        let block_b2 = tf
            ...
            .build();
        let b2_outpoint_id: OutPointSourceId = block_b2.get_id().into();
        assert!(
        ...
        let block_c2 = tf
            ...
            .build();
        let c2_outpoint_id: OutPointSourceId = block_c2.get_id().into();
        assert!(
        ...
        let block_d2 = tf
            ...
            .build();
        let d2_outpoint_id: OutPointSourceId = block_d2.get_id().into();
        assert!(
...
fn spend_different_token_than_one_in_input(#[case] seed: Seed) {
    utils::concurrency::model(move || {
        ...
        let block = tf.block(*block_index.block_id());
        let first_issuance_outpoint_id: OutPointSourceId = block.get_id().into();
        ...
        let block = tf.block(*block_index.block_id());
        let second_issuance_outpoint_id: OutPointSourceId = block.get_id().into();
