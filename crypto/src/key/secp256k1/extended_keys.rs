...
impl Derivable for Secp256k1ExtendedPrivateKey {
    fn derive_child(self, num: ChildNumber) -> Result<Self, DerivationError> {
        ...
        let derivation_path = {
            let mut child_path = self.derivation_path.clone().into_vec();
            child_path.push(num);
            child_path.try_into()?
        };
...
mod test {
    ...
    fn serialization() {
        ...
        let pk_hex = "007923408dadd3c7b56eed15567707ae5e5dca089de972e07f3b860450e2a3b70ed902f35f560e0470c63313c7369168d9d7df2d49bf295fd9fb7cb109ccee0494";
    ...
    fn derivation_private_key() {
        ...
        assert_encoded_eq(&master_pub_key, "007923408dadd3c7b56eed15567707ae5e5dca089de972e07f3b860450e2a3b70ed902f35f560e0470c63313c7369168d9d7df2d49bf295fd9fb7cb109ccee0494");
